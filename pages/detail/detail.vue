<template>
	<view class="detail">
		<musicheader :title="songDetail.name" :icon="true"></musicheader>
...
<script>
	...
	import { songSimi  } from '../../common/api.js';
	import { songComment  } from '../../common/api.js';
	...
	export default {
		...
		methods: {
			...
			if(res[1].data.code == '200'){
				...
				// #endif
				this.bgAudioMannager.src = res[1].data.data[0].url;
...
<style scoped>
	...
	.detail-play{ width:580rpx; height:580rpx;  background-size:cover; margin:210rpx auto 44rpx auto; position: relative;}
	...
	.detail-play text{ width:100rpx; height:100rpx; font-size:100rpx; position: absolute; left:0; top:0; right:0; bottom:0; margin:auto; color:black;}
	...
	.detail-like-title{ font-size:36rpx; color:black; margin:50rpx 0;}
	.detail-like-list{}
	...
	.detail-like-song view:nth-child(1){ color:black; font-size:30rpx; width:70vw; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin-bottom: 10rpx;}
	...
	.detail-comment-title{ font-size:36rpx; color:black; margin:50rpx 0;}
	...
	.detail-comment-content{ flex:1; color:black;}
	...
	.detail-comment-text{ line-height: 40rpx; color:black; font-size:28rpx; margin-top:16rpx; border-bottom:1px #595860 solid; padding-bottom: 40rpx;}
